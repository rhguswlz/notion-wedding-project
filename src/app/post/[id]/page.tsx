 ...
 *
 * generateStaticParams를 사용하면 빌드 시 모든 포스트 경로를 정적 생성합니다.
 */
export const revalidate = CACHE_REVALIDATE.post
export const dynamicParams = true // 새로운 포스트가 추가되면 동적 생성
